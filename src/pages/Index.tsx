...
const Index = () => {
  ...
  const screenshots = [
    ...
    { title: "Game Selection", description: "Choose from 4 exciting game types" },
    { title: "Betting Interface", description: "Place your bets with confidence" },
    { title: "Results & Winnings", description: "Track your wins and earnings" }
  ];
  ...
  const features = [
    { icon: <Smartphone className="w-6 h-6" />, title: "Easy Interface", description: "User-friendly design for seamless betting" },
    { icon: <Zap className="w-6 h-6" />, title: "Live Results", description: "Real-time updates and instant notifications" },
    { icon: <Shield className="w-6 h-6" />, title: "Secure Wallet", description: "Safe and encrypted payment system" },
    { icon: <Trophy className="w-6 h-6" />, title: "Daily Wins", description: "Multiple opportunities to win every day" }
  ];

  const faqs = [
    {
      question: "Is betting legal on this platform?",
      answer: "Khai Wala operates in compliance with local regulations. Please check your local laws regarding online betting before participating."
    },
    {
      question: "How are winners decided?",
      answer: "Winners are determined through a transparent and fair random number generation system. Results are published in real-time for all participants to see."
    },
    {
      question: "Is my money safe?",
      answer: "Yes, we use bank-grade encryption and secure payment gateways. Your funds are protected with multiple layers of security."
    },
    {
      question: "How do I withdraw my winnings?",
      answer: "Winnings can be withdrawn instantly to your bank account or digital wallet through our secure payment system."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto animate-fade-in">
            A safe and exciting online Matka betting experience with 4 unique game types: 
              ...
              <div className="bg-black rounded-2xl p-1">
                <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-xl h-96 flex items-center justify-center">
                  <div className="text-center text-white p-6">
                    ...
                    <p className="text-sm opacity-80">Choose your lucky numbers</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-black/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Choose Khai Wala?</h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
              Experience the best in online Matka betting with our advanced features and secure platform
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Four Exciting Game Types</h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
            ...
            <div className="bg-gradient-to-b from-gray-800 to-gray-900 rounded-3xl p-4 shadow-2xl">
              <div className="bg-black rounded-2xl p-2">
                <div className="bg-gradient-to-br from-purple-600 to-blue-600 rounded-xl h-96 flex items-center justify-center relative overflow-hidden">
                  <div className="text-center text-white p-6">
                    <h3 className="font-bold text-lg mb-2">{screenshots[currentScreenshot].title}</h3>
                    <p className="text-sm opacity-80">{screenshots[currentScreenshot].description}</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300">Start winning in just 3 simple steps</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              { step: "1", title: "Select a Game", description: "Choose from Harup, Jodi, Crossing, or Single", icon: <Play className="w-8 h-8" /> },
              { step: "2", title: "Place Your Bet", description: "Pick your lucky numbers and bet amount", icon: <Trophy className="w-8 h-8" /> },
              { step: "3", title: "Win Big", description: "If your number matches, you win the prize!", icon: <Star className="w-8 h-8" /> }
            ].map((item, index) => (
      ...
      <section className="py-20 bg-black/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300">Get answers to common questions about Khai Wala</p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-sm text-gray-400 mt-4">Available for Android devices</p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-black/50 border-t border-white/10">
        <div className="container mx-auto px-4 py-12">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                The most trusted platform for online Matka betting with secure payments and fair play.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-white/10 mt-8 pt-8 text-center">
            <p className="text-gray-400 text-sm">
              © 2024 Khai Wala. All rights reserved. | 18+ Only | Play Responsibly
            </p>
          </div>
        </div>
      </footer>
